  ...
  return (
    <div className="relative h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/background.jpg')" }}>
      ...
      <div className="relative flex justify-center items-center h-full z-10">
        <div className="bg-black bg-opacity-80 p-6 sm:p-8 md:p-10 rounded-lg shadow-lg text-center text-white w-[90%] sm:w-[500px]"> {/* Responsive width */}
          <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">OTP Verification</h1>
          <p className="mb-6 sm:mb-8 text-gray-300 text-sm sm:text-base">
            Enter the 6-digit OTP sent to your Twitter account.
          </p>
          ...
          <div className="flex justify-center gap-2 sm:gap-4 mb-6 sm:mb-8">
            {otpInput.map((digit, index) => (
              <input
                ...
                className="w-10 h-10 sm:w-16 sm:h-16 text-center text-lg sm:text-xl font-bold text-white bg-transparent border-2 sm:border-4 border-yellow-500 rounded-full focus:outline-none focus:ring-2 sm:focus:ring-4 focus:ring-yellow-400"
              />
            ))}
          </div>
          ...
          <button
            ...
            className={`w-full py-2 sm:py-3 text-base sm:text-lg font-bold rounded-lg ${isVerifying ? 'bg-gray-500 cursor-not-allowed' : 'bg-yellow-500 hover:bg-yellow-600'}`}
