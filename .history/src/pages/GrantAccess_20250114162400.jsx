  ...
  return (
    <div className="flex flex-col items-center h-screen bg-black text-white px-4">
      ...
      <div className="flex flex-col items-center justify-center h-full w-full">
        {/* Page Header */}
        <h1 className="text-2xl font-bold text-center px-6 mb-8 leading-snug">
        ...
        <div className="w-full max-w-md space-y-6">
          <div className="relative">
            <input
              ...
              className="w-full p-4 text-white bg-black border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg placeholder-transparent peer"
              value={input}
          ...
          <button
            className="w-full py-4 bg-blue-500 text-white font-bold rounded-lg text-lg hover:bg-blue-600 transition duration-300 mb-4"
