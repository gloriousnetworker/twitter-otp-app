    ...
    <div className="relative h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/Dashboard.jpg')" }}>
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between h-full z-10 px-6 md:px-10">
        ...
        <div className="w-full md:w-1/2 text-white space-y-6 mb-10 md:mb-0">
          {/* Welcome Text */}
          <h1 className="text-4xl md:text-6xl font-extrabold text-yellow-500">Welcome to UNICRYPTO, {username}!</h1>
          <p className="text-lg md:text-2xl font-semibold text-gray-300 mb-4">Your journey into the world of digital currencies begins here.</p>

          {/* Subheading Texts */}
          <h2 className="text-lg md:text-xl text-gray-400 mb-3">Stay updated with real-time crypto prices</h2>
          <h2 className="text-lg md:text-xl text-gray-400 mb-3">Track your portfolio effortlessly</h2>
          <h2 className="text-lg md:text-xl text-gray-400 mb-3">Get insights into the latest market trends</h2>
          <h2 className="text-lg md:text-xl text-gray-400 mb-6">Maximize your investments with expert advice</h2>
        ...
        <div className="w-full md:w-1/2 relative">
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full md:w-[400px] h-[400px] md:h-[500px] bg-black bg-opacity-70 rounded-2xl shadow-xl p-6">
            ...
            <h3 className="text-white text-2xl md:text-3xl font-bold mb-4">Your Portfolio Overview</h3>
