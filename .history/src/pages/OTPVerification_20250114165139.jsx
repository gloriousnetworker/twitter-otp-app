...
const OTPVerification = () => {
  ...
  useEffect(() => {
    // Simulate receiving OTP through an alert
    const storedOtp = "123456"; // Replace with dynamic OTP fetching logic
    localStorage.setItem('otp', storedOtp);
    const userOtp = window.confirm(`Your OTP is: ${storedOtp}. Click OK to autofill.`);
    if (userOtp) {
      setOtpInput(storedOtp.split(''));
    }
  }, []);
