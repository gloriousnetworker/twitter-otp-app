...
const Login = () => {
  ...
  const handleLogin = () => {
    ...
    // Set the redirect message and simulate a small delay before navigating
  ...
  return (
    <div
      ref={bgRef}
      className={`h-screen flex flex-col justify-center items-center bg-cover bg-center relative transition-opacity duration-500 ${
        bgLoaded ? 'opacity-100' : 'opacity-0'
      }`}
      style={{
        backgroundImage: bgLoaded ? "url('/background.jpg')" : 'none',
      }}
    >
      ...
      <div className="relative z-10 p-8 w-full max-w-md">
        ...
        >
          ...
          {isRedirecting ? "Redirecting to Twitter..." : "Sign in with Twitter"}
        </button>
      </div>
    </div>
  );
